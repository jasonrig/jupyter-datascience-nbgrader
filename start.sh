...
export LD_LIBRARY_PATH="/opt/conda/lib/R/lib"
...
if [ $(id -u) == 0 ] ; then
    ...
    exec sudo -E -H -u $NB_USER PATH=$PATH LD_LIBRARY_PATH=$LD_LIBRARY_PATH XDG_CACHE_HOME=/home/$NB_USER/.cache PYTHONPATH=$PYTHONPATH "${cmd[@]}"
else
